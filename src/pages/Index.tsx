...
const Index = () => {
  return <GradientBackground variant={0}>
      ...
      <div className="px-2 pt-12 sm:pt-20 pb-2 max-w-4xl mx-auto flex flex-col items-center py-[24px] sm:px-[12px]">
        <h2 className="font-playfair text-4xl font-bold text-center mb-5 bg-gradient-to-r from-yellow-400 via-pink-300 to-blue-200 text-transparent bg-clip-text py-[8px] sm:text-5xl">
